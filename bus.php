...
<body>
<!-- top-header -->
<div class="top-header navbar navbar-fixed-top" style="background:#DAA520;">
	<div class="container">
		...
		?>
	<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 				
			<li class="sig"><a href="#" data-toggle="modal" data-target="#myModal" style="color:yellow;">Halo <?php echo"$_SESSION[nama]";?></a></li> 
			<li class="sigi"><a href="logout.php" style="color:yellow;">/ Keluar</a></li>
        </ul>
		<?php
		}
		?>
...
<div class="footer-top">
	<div class="container">
		<div class="col-md-6 footer-left wow fadeInLeft animated" data-wow-delay=".5s">
			<h3 style="color:	#008080;">Kategori Mobil</h3>
				<ul>
				 <?php
			$row = $do->selectMerek();
			$no = 1;
		...
		<div class="col-md-6 footer-left wow fadeInRight animated" data-wow-delay=".5s">
			<h3 style="color:#008080;">Perjalanan</h3>
				<ul>
			<?php
			$row = $do->selectKota();
			$no = 1;
...
<div class="copy-right">
	...
	<div  style="list-style-type: none;margin-left: 45%;padding: 0;overflow: hidden;" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2020 Pengembangan Peragkat Lunak | Design by Muflika Rahmadani </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<section>
								<div class="modal-body modal-spa">
									<div class="writ">
										<h4>BAGAIMANA KAMI DAPAT MEMBANTU ANDA</h4>
											<ul>
												<li class="na-me">
